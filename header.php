        ...
        <nav class="navigation">
            ...
            <div class="navigation__menu">
                <ul class="navigation__list">
                    ...
                    <li class="navigation__item">
                        <a href="about.php" class="navigation__link about">About</a>
                        <!-- <ul class="dropdown">
                            <li class="dropdown__item">
                                <a href="#" class="dropdown__link">About Us</a>
                            </li>
                            <li class="dropdown__item">
                                <a href="#" class="dropdown__link">Mission, Vision and Objectives</a>
                            </li>
                        </ul> -->
                    </li>
                    <li class="navigation__item">
                        ...
                        <ul class="dropdown">
                            ...
                            <li class="dropdown__item">
                                <a href="mba.php" class="dropdown__link">MBA</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation__item">
                    ...
                    <li class="navigation__item">
                        <span data-toggle="modal" data-target="#basicExampleModal3"><i class="fas fa-search"></i></span>
                    </li>
                </ul>
            </div>
        ...
        <ul class="navigation-toggle-list">
                    ...
                    <li class="navigation-toggle-item">
                        ...
                        <ul class="toggle-dropdown">
                            ...
                            <li class="toggle-dropdown__item">
                                <a href="#" class="toggle-dropdown__link">Scholarship</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-toggle-item">
